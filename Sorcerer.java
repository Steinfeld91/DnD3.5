...
public class Sorcerer extends Race
{
	...
	private String[][] SKILL_META_DATA = 		
												/*   Meta data array [52 rows] [2 columns]
												Rows: = each skill in skillPointArray in alphabetical order
												Columns: 0 = name of skill, 1 = notate Untrained skill or class skill
	...
	public Sorcerer(String n, String r) 
	{
		setName(n);
		setRace(r);
		setCharClass("Sorcerer");
	...
	public void calcStats()
	{
		...
		reflexSave = 0 + getDEXMod();
		willSave = 2 + getWISMod();
	...
	{
		startingSkillPts = (2 + getINTMod()) * 4;
	...
	public String toString()
	{
		...
		for (i = 0; i < 52; i++) 
		{
			...
			if (SKILL_META_DATA[i][1].contains("U")
					||
				SKILL_META_DATA[i][1].contains("SO")
					||
				skillPointArray[i] > 0) 
			{

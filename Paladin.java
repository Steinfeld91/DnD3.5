...
public class Paladin extends Race
{
	private int HP;
	...
	public void calcStats()
	{
		...
		HP = 10 + getCONMod();
		fortSave = 2 + getCONMod();
		reflexSave = 0 + getDEXMod();
		willSave = 0 + getWISMod();
		meleeAttack = 1 + getSTRMod();
		rangedAttack = 1 + getDEXMod();
	...
	{
		String str = getAlignment().toUpperCase();
		return str.contains("LAWFUL GOOD");
	}///////////////////////////////////////////////////////////////////
	...
	public String toString()
	{
		...
		for (i = 0; i < 52; i++) 
		{
			...
			if (SKILL_META_DATA[i][1].contains("U")
					||
				SKILL_META_DATA[i][1].contains("PA")
					||
				skillPointArray[i] > 0) 
			{
